...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT"))
            await idk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT_GROUP"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT"))
            await ydk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT_GROUP"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT"))
            await wdk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT_GROUP"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT"))
            await hdk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT_GROUP"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT"))
            await sdk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT_GROUP"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT"))
            await adk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT_GROUP"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT"))
            await bdk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT_GROUP"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT"))
            await ddk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT_GROUP"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT"))
            await edk(functions.channels.JoinChannelRequest(channel="@DAREDEVIL_SUPPORT_GROUP"))
